...
class StudentClass:
    def __init__(self, root):
        ...
        self.root.focus_force() 
         ...
         # title--  
        title = Label(self.root, text="Manage Student Details", bg = "#033054", fg="white", font=("goudy old style", 20, "bold"))
      ...
      #=================column2=================
       ...
       # entries
        ...
        self.txt_course.set("Select the course")
       #=================text address=================
        ...
        txt_search_roll=Entry(self.root, textvariable=self.var_search, font=("goudy old style", 15, 'bold'), bg='lightyellow').place(x=950, y=60, width=180)
